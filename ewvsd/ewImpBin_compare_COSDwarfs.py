...
#        f.close()
    ...
    plt.errorbar(imp, ewmean, xerr=[horizerrneg,horizerrpos],yerr=[verterrneg,verterrpos], c=colors[i], marker=mark[i], label=galID_names[i], linestyle='none')
...
s = ion+'_ewspace_cut_{0:d}mA_compare.eps'.format(int(ewcut*1000))
plt.savefig(s)
