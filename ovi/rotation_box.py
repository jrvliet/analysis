...
boxFileName = 'vela2b-{0:d}.{1:.3f}.OVI.i90.abs_cells.h5'
# boxFileName = 'vela2b-{0:d}_GZa{1:.3f}.OVI.h5'
linesName = 'lines.info'
rotFileName = '../../rotmat_a{0:.3f}.txt'
outFileName = 'vela2b-{0:d}.a{1:.3f}.i90_OVIcellsGalFrame_abscells.h5'


linesHeader = 'losnum impact phi inclination'.split()
# cols = 'x y z vx vy vz nH temperature SNII SNIa nIon cell_size'.split()
cols = ['x', 'y', 'z', 'vx', 'vy', 'vz', 'nH', 
        'temperature', 'SNII', 'SNIa', 'ion_density', 'cell_size']
outHeader = ['cellID','x','y','z','vx','vy','vz',
             'r','theta','phi','vr','vtheta','vphi',
             'nH', 'temperature', 'SNII', 'SNIa','nIon']
...
for galNum in galNums:
    ...
    fname = loc+boxFileName.format(galNum,a)
