...
location = '/mnt/cluster/abs/cgm/vela2a/'
halo_list = [25, 26, 27, 28]
expn = '0.490'
incline = 90
ions = ['HI', 'MgII', 'CIV', 'OVI']

absfileBase = 'vela2a-{0:d}.{1:s}.{2:s}.i{3:d}.abs_cells.h5'
sysabsfileBase = 'vela2a-{0:d}.{1:s}.a{2:s}.i{3:d}.ALL.sysabs.h5'
stat = 'mean' 
statname = 'mean'
...
for galNum in halo_list:
    ...
    fig.tight_layout()
    fig.savefig('pahist_vela2a-{0:d}_ew_{1:s}_ewcut{2:d}mA.pdf'.format(galNum, statname, int(1000*ewcut)), bbox_inches='tight')
