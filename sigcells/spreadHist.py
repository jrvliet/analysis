...
'''
Plot a histgram of the spreads reported by clumping.py
'''
...
ax1.set_xlabel('Spread Normalized Cell Loc')
ax1.set_ylabel('Counts')
fig1.savefig('spreadHist.png', bbox_inches='tight')
